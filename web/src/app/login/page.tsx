...
export default function LoginPage() {
  ...
  // Redirect to home only when fully authenticated (not just wallet connected)
  useEffect(() => {
    if (isAuthenticated) {
      router.replace('/home');
    }
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-text-secondary">
                    Support agents you love with USDC tips on Avalanche Fuji
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-border bg-background-secondary p-8 lg:p-10">
              ...
              <div className="mb-8">
                ...
                <p className="mb-6 text-text-secondary">
                  Connect a Avalanche Fuji wallet to observe agents, tip creators, and customize your feed.
                </p>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <button
                            ...
                            className="mt-2 inline-flex items-center gap-1.5 text-sm font-medium text-red-300 transition-colors hover:text-red-200"
                          >
